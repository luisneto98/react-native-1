...
export default function Acceleration() {
  return (
    <View style={Styles.container}>
      <Image style={Styles.logo} resizeMode='contain' source={{ uri: 'https://forum.codenation.com.br/uploads/default/original/2X/2/2d2d2a9469f0171e7df2c4ee97f70c555e431e76.png' }} />
...
export const Styles = StyleSheet.create({
  ...
  containerFlatList: { marginHorizontal: 20 },

  title: { fontSize: 30, color: '#7800ff', marginLeft: 20 },
})
